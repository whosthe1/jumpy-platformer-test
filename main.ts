class SpriteKindLegacy {
    ...
    static Bumper: number
    private ___Bumper_is_set: boolean
    private ___Bumper: number
    get Bumper(): number {
        return this.___Bumper_is_set ? this.___Bumper : SpriteKindLegacy.Bumper
    }
    set Bumper(value: number) {
        this.___Bumper_is_set = true
        this.___Bumper = value
    }
    
    static Goal: number
    private ___Goal_is_set: boolean
    private ___Goal: number
    get Goal(): number {
        return this.___Goal_is_set ? this.___Goal : SpriteKindLegacy.Goal
    }
    set Goal(value: number) {
        this.___Goal_is_set = true
        this.___Goal = value
    }
    
    static Coin: number
    private ___Coin_is_set: boolean
    private ___Coin: number
    get Coin(): number {
        return this.___Coin_is_set ? this.___Coin : SpriteKindLegacy.Coin
    }
    set Coin(value: number) {
        this.___Coin_is_set = true
        this.___Coin = value
    }
    
    static Flier: number
    private ___Flier_is_set: boolean
    private ___Flier: number
    get Flier(): number {
        return this.___Flier_is_set ? this.___Flier : SpriteKindLegacy.Flier
    }
    set Flier(value: number) {
        this.___Flier_is_set = true
        this.___Flier = value
    }
    ...
    public static __initSpriteKindLegacy() {
        ...
        SpriteKindLegacy.Bumper = 4
        SpriteKindLegacy.Goal = 5
        SpriteKindLegacy.Coin = 6
        SpriteKindLegacy.Flier = 7
    }
...
sprites.onOverlap(SpriteKindLegacy.Player, SpriteKindLegacy.Coin, function on_overlap_player_coin(sprite: Sprite, otherSprite: Sprite) {
...
sprites.onOverlap(SpriteKindLegacy.Player, SpriteKindLegacy.Goal, function on_overlap_player_goal(sprite2: Sprite, otherSprite2: Sprite) {
...
function clearGame() {
    for (let value4 of sprites.allOfKind(SpriteKindLegacy.Bumper)) {
        value4.destroy()
    }
    for (let value5 of sprites.allOfKind(SpriteKindLegacy.Coin)) {
        value5.destroy()
    }
    for (let value6 of sprites.allOfKind(SpriteKindLegacy.Goal)) {
        value6.destroy()
    }
    for (let value7 of sprites.allOfKind(SpriteKindLegacy.Flier)) {
        value7.destroy()
    }
}

sprites.onOverlap(SpriteKindLegacy.Player, SpriteKindLegacy.Bumper, function on_overlap_player_bumper(sprite3: Sprite, otherSprite3: Sprite) {
    if (sprite3.vy > 0 && !sprite3.isHittingTile(CollisionDirection.Bottom) || sprite3.y < otherSprite3.top) {
...
sprites.onOverlap(SpriteKindLegacy.Player, SpriteKindLegacy.Flier, function on_overlap_player_flier(sprite4: Sprite, otherSprite4: Sprite) {
    info.changeLifeBy(-1)
...
game.onUpdate(function on_on_update2() {
    for (let value8 of sprites.allOfKind(SpriteKindLegacy.Bumper)) {
...
game.onUpdate(function on_on_update3() {
    for (let value9 of sprites.allOfKind(SpriteKindLegacy.Flier)) {
